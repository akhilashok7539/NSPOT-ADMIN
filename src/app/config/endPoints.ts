export const endPoints = {
    ...
    Update_bankDetails: 'institute/bank-details/update/', // :bankId
    ...
    Get_banks: 'institute/banks/list', // ?where[id]=id
    ...
    Create_accademicLevel: 'academic-level/create',
    Get_academicLevels: 'academic-level/',
    Create_levelCourse: 'academic-level/courses/create',
